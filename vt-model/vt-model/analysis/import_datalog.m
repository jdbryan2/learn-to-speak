function [A_rearr, Alab, samp_freq, num_samp, des_samp_freq] = ...
import_datalog(testname,filename)
% Import datalog file generated by vt-model
%filename = 'test1/logs/datalog8.log';
delimiterIn = '\t';
headerlinesIn = 8;
A = importdata([testname, '/logs/', filename],delimiterIn,headerlinesIn);

des_samp_freq = str2double(cell2mat(A.textdata(2)));
samp_freq = str2double(cell2mat(A.textdata(4)));
num_samp = str2double(cell2mat(A.textdata(6)));
